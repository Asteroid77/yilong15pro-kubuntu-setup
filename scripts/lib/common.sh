...
readonly REPO_GLOW="charmbracelet/glow"
readonly REPO_ATUIN="atuinsh/atuin"
readonly REPO_KITTY="kovidgoyal/kitty"
readonly REPO_TMUX_RESURRECT="tmux-plugins/tmux-resurrect"
readonly REPO_TMUX_CONTINUUM="tmux-plugins/tmux-continuum"
readonly KITTY_INSTALLER_URL="https://sw.kovidgoyal.net/kitty/installer.sh"
...
select_install_features() {
    local -a FEATURES=(
        ...
        "yakuake_snapshot|Yakuake snapshot tabs|off"
        "tmux_restore|tmux restore for Konsole/Yakuake|off"
        "wezterm_tmux|WezTerm + tmux GUI tabs|off"
        "kitty_terminal|kitty|off"
